...
<body>
    <div class="header">
        <h1>LAPORAN BULANAN {{ $disease_label }}</h1>
        <h2>{{ $period }}</h2>
    </div>

    <div class="month-highlight">
        LAPORAN BULAN {{ strtoupper(date('F Y', mktime(0, 0, 0, $month, 1, $year))) }}
    </div>
    ...
    <div class="summary-box">
        <h3>RINGKASAN STATISTIK BULANAN</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="target-col">TARGET BULANAN</th>
    ...
    <div class="footer">
        <p>Laporan Bulanan dibuat pada: {{ $generated_at }}</p>
