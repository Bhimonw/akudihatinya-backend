...
class PatientSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($puskesmas as $puskesmas) {
            // Reset counter untuk setiap puskesmas
            $this->patientCounters[$puskesmas->id] = 1;
            ...
            for ($i = 0; $i < $numPatients; $i++) {
                ...
                // Generate unique medical record number using puskesmas_id and timestamp
                $timestamp = substr(time(), -4); // Ambil 4 digit terakhir dari timestamp
                $medicalRecordNumber = sprintf('RM-%03d-%s', $puskesmas->id, $timestamp);
