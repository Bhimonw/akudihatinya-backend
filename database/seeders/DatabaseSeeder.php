...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Disable specific model events that might trigger cache updates
        Event::listen('eloquent.created: App\Models\HtExamination', function () {
            return false;
        });
        Event::listen('eloquent.created: App\Models\DmExamination', function () {
            return false;
        });
        Event::listen('eloquent.updated: App\Models\HtExamination', function () {
            return false;
        });
        Event::listen('eloquent.updated: App\Models\DmExamination', function () {
            return false;
        });
        ...
        Event::forget('eloquent.created: App\Models\HtExamination');
        Event::forget('eloquent.created: App\Models\DmExamination');
        Event::forget('eloquent.updated: App\Models\HtExamination');
        Event::forget('eloquent.updated: App\Models\DmExamination');
    }
